    ...
    <div className="skills-content">
        ...
        <div className="skills-box">
            <div className="skills-group">
                ...
                <div>
                    <h3 className="skills-name">CSS/SCSS</h3>
                    <span className="skills-level">Advanced</span>
                </div>
                </div>
                <div className="skills-data">
                <i class='bx bx-badge-check' ></i>
                <div>
                    <h3 className="skills-name">JavaScript/Jquery</h3>
                    <span className="skills-level">Advanced</span>
                </div>
                </div>
                <div className="skills-data">
            ...
            <div className="skills-group">
                ...
                <div>
                    <h3 className="skills-name">Antd/Boostrap</h3>
                    <span className="skills-level">Intermediate</span>
                </div>
                </div>
                <div className="skills-data">
                ...
                <div>
                    <h3 className="skills-name">ReactNative</h3>
                    <span className="skills-level">Basic</span>
                </div>
                </div>
            </div>
